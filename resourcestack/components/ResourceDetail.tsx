    ...
    <div className="space-y-4">
      <div className="flex items-center justify-between">
        ...
        <a
          ...
          target="_blank"
          rel="noreferrer"
          className="inline-flex items-center gap-2 rounded-2xl bg-zinc-950 px-3 py-2 text-sm font-semibold text-white no-underline hover:bg-zinc-900 dark:bg-white dark:text-zinc-950 dark:hover:bg-zinc-100"
        >
      ...
      <div className="rounded-3xl bg-zinc-100/80 p-6 shadow-soft ring-1 ring-black/10 dark:bg-zinc-900/50 dark:ring-white/10">
        <div className="grid gap-5 lg:grid-cols-[1fr_340px]">
          <div className="space-y-4">
            ...
            <div>
              <label className="text-xs text-zinc-600 dark:text-zinc-300">Notes</label>
              <textarea
            ...
            <div className="flex flex-col gap-2 sm:flex-row">
              <button
                onClick={save}
                disabled={saving}
                className="inline-flex flex-1 items-center justify-center gap-2 rounded-2xl bg-zinc-950 px-3 py-2 text-sm font-semibold text-white hover:bg-zinc-900 disabled:opacity-60 dark:bg-white dark:text-zinc-950 dark:hover:bg-zinc-100"
              >
          ...
          <div className="rounded-3xl bg-zinc-200/50 p-5 ring-1 ring-black/10 dark:bg-zinc-950/40 dark:ring-white/10">
            ...
            <div className="mt-4 flex gap-2">
              ...
              <button
                onClick={addTag}
                className="rounded-2xl bg-zinc-950 px-3 py-2 text-sm font-semibold text-white hover:bg-zinc-900 dark:bg-white dark:text-zinc-950 dark:hover:bg-zinc-100"
              >
                Add
              </button>
            </div>
            ...
            <div className="mt-4 flex flex-wrap gap-2">
              ...
              {resource.tags.length === 0 ? (
                <div className="text-sm text-zinc-600 dark:text-zinc-300">No tags yet.</div>
              ) : null}
            </div>
